    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
          <img src="/img/logo.png" alt="Nón Lá Tourist" class="navbar-logo" />
        </a>
        <button
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <!-- <li class="nav-item">
              <nuxt-link
                ...
                class="nav-link active"
                aria-current="page"
                >Danh Sách Tour</nuxt-link
              >
            </li>
            <li class="nav-item">
              <nuxt-link
                @click="navigateTo('/areas/listAreas')"
                href=""
                class="nav-link active"
                aria-current="page"
            ...
            >
        <router-link :to="`/areas/${i.area_slug}`" class="nav-link active">
          {{ i.area }}
        </router-link>
            </li>
          </ul>
          ...
          <nuxt-link to="/auth/Login" class="mx-3"
...
const { data: areas, refresh: refreshAreas } = await useFetch(
  `${runtimeConfig.public.apiBase}/areas`,
  { method: "get" }
);
...
.navbar-logo {
  ...
  margin-right: 10px; /* Tùy chỉnh khoảng cách giữa logo và văn bản */
}
</style>
